...
namespace HRSystem.Features.Role.AssignRoleToUser.Commands
{
    ...
    public class AssignRoleToUserCommandHandler : RequestHandlerBase<AssignRoleToUserCommand, AssignRoleToUserResponseVM>
    {
        ...
        public AssignRoleToUserCommandHandler(IGeneralRepository<HRSystem.Models.UserRole> generalRepository, RequestHandlerBaseParameters parameters) : base(parameters)
        {
        ...
        public override async Task<RequestResult<AssignRoleToUserResponseVM>> Handle(AssignRoleToUserCommand request, CancellationToken cancellationToken)
        {
            ...
            var res= await _userRoleRepository.AddAsync(mapper.Map<HRSystem.Models.UserRole>(request.AssignRoleToUserDTO));
